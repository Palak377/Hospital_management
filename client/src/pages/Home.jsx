          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            <div>
              <div className="lg:w-[570px]">
                ...
                <button onClick={handleReqBtnClick} className="btn">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[80px] lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-[16px] leading-7 text-textColor font-[400] mt-1 text-center max-w-[470px]">
                Explore our list of expert doctors to find the perfect match for
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-[16px] leading-7 text-textColor font-[400] mt-1 text-center max-w-[470px]">
                Discover the nearest healthcare facility or doctor to you with
                our easy location finder
              </p>
              <Link to="/contact">
                <div className="w-9 h-9 mt-4 rounded-full flex items-center justify-center hover:bg-primaryColor hover:text-white">
                  <BsArrowRightCircle className="w-8 h-8" />
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-[16px] leading-7 text-textColor font-[400] mt-1 text-center max-w-[470px]">
                Secure your spot with a simple and convenient appointment
                booking process
              </p>
              <Link to="/doctors">
                <div className="w-9 h-9 mt-4 rounded-full flex items-center justify-center hover:bg-primaryColor hover:text-white">
        ...
        <div className="container">
          <div className="max-w-[470px] mx-auto">
            ...
            <p className="text_para text-center">
              Explore our diverse range of medical services designed to cater to
      ...
      <section className="pb-0">
        <div className="container">
          <div className="max-w-[470px] mx-auto">
            ...
            <p className="text_para text-center">
              Discover what our patients are saying about their experiences with
              us through testimonials
            </p>
          </div>
        </div>
        <Testimonials />
