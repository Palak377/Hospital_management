    ...
    <div>
      <span className="lg:hidden">
        {!menu ? (
          ...
          <BiX onClick={toggle} className="w-6 h-6 cursor-pointer" />
        )}
      </span>
      <div
        className="options max-w-[500px] lg:flex flex-col p-[30px] bg-white shadow-panelShadow items-center h-max rounded-md"
        ref={newRef}
      >
        <button
        ...
        <div className="mt-[60px] text-center w-full">
          ...
          <button
            ...
            className="w-full bg-red-600 p-3 text-[16px] text-white leading-7 rounded-md"
          >
            Delete Account
          </button>
        </div>
